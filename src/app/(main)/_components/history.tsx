...
const HistorySection = () => {
  return (
    <section className="w-full overflow-hidden relative py-20 ">
      <Image src={HistoriaBg} alt="Matupi" className="lg:flex hidden" />
      <Image src={HistoriaBgMobile} alt="Matupi" className="lg:hidden flex" />

      <div className="w-full h-full absolute z-10 top-32 ">
        <Container>
          <div className="flex lg:flex-row flex-col w-full h-[650px] justify-end lg:items-center items-end">
            <div className="flex flex-col gap-5 max-w-[500px]">
              ...
              <Link
                href={"/sobre-nos"}
                className="group w-fit bg-transparent text-[#f30808] border-2 border-[#f30808] rounded-full flex flex-row gap-3 items-center lg:text-xl text-md py-3 
      ...
      <svg
        ...
        viewBox="0 0 480 480"
        className="absolute lg:w-[400px] hidden -right-32 -top-52 rotate-x-12 "
      >
        <path
